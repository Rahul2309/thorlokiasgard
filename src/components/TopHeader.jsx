                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 col-xl-6">
                        <ul class="nav__top__left">
                            <li> <MailSvg /> thorLokiSchool@gmail.coom</li>
                            ...
                            </svg> 4297 Libby Street, Beverly Hills, California</li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-2 col-xl-6">
                        <ul class="top__social">
                            <li><a href="https://graphtheme.com/www.factbook.com"><svg aria-hidden="true" focusable="false"
